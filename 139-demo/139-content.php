...
?>
<div class="type-139" style="background:url(http://<?php echo $url_path ?>/images/bg_pattern.png ) center center;">
    <div class="container">
        <div class="row">
            <!--LEFT SIDE BAR-->
            <!--/END LEFT SIDE BAR-->
                ...
                <div class="topnews">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body news">
                            ...
                            <!--TOP NEWS-->
                            <div class="topnews plr-20 ptb-25">
                                <div class="row">
                                    <div class="col-md-6 border-r">
                                        <div class="row">
                                            <div class="col-md-4 topnewstime">
                                                <div class="topnewdate">
                                                <span class="topnewsday">19</span><br>
                                    ...
                                    <div class="col-md-6 right">
                                        <div class="row">
                                            <div class="col-md-4 topnewstime">
                                                <div class="topnewdate">
                                                <span class="topnewsday">12</span><br>
                                                <span class="topnewsmonth">Tháng 01</span><br>
                                            </div>
                                            </div>
                                            <div class="col-md-8 bottom" >
